...
controllers.controller('homeCtrl', function ($scope, $http, flickr) {
...
controllers.controller('ProjectsCtrl', function ($routeParams, $scope, flickr) {
	var id = $routeParams.id;
	flickr.project(id).then(function (data) {
